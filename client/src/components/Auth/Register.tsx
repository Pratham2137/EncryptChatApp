        ...
        <form onSubmit={handleRegister} className="mt-6 space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="
                  ...
                  dark:placeholder:text-[var(--color-text-secondary-darkmode)]
                  focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]
                  dark:focus:ring-[var(--color-primary-darkmode)]
                "
              />
            </div>
          </div>
          ...
          <button
            ...
            className="
              ...
              dark:bg-[var(--color-primary-darkmode)] dark:hover:bg-[var(--color-primary-dark-darkmode)]
        ...
        >
          ...
          <Link
            ...
            className="
              ...
              dark:text-[var(--color-primary-darkmode)] dark:hover:text-[var(--color-primary-dark-darkmode)]
            "
          >
            Terms of Use
          </Link>
